...
const parse_all_of_js_1 = require("./parse-all-of.js");
const parse_any_of_js_1 = require("./parse-any-of.js");
const parse_one_of_js_1 = require("./parse-one-of.js");
const parse_schema_js_1 = require("./parse-schema.js");
const its_js_1 = require("../utils/its.js");
function parseObjectProperties(objectSchema, refs) {
    ...
    for (const key of propertyKeys) {
        ...
        const propZodSchema = (0, parse_schema_js_1.parseSchema)(propJsonSchema, {
            ...refs,
...
function parseObject(objectSchema, refs) {
    ...
    const additionalProperties = objectSchema.additionalProperties !== undefined
        ? (0, parse_schema_js_1.parseSchema)(objectSchema.additionalProperties, {
            ...refs,
    ...
    if (objectSchema.patternProperties) {
        const parsedPatternProperties = Object.fromEntries(Object.entries(objectSchema.patternProperties).map(([key, value]) => {
            return [
                key,
                (0, parse_schema_js_1.parseSchema)(value, {
                    ...refs,
    ...
    if (its_js_1.its.an.anyOf(objectSchema)) {
        output = output.and((0, parse_any_of_js_1.parseAnyOf)({
            ...objectSchema,
    ...
    if (its_js_1.its.a.oneOf(objectSchema)) {
        output = output.and((0, parse_one_of_js_1.parseOneOf)({
            ...objectSchema,
    ...
    if (its_js_1.its.an.allOf(objectSchema)) {
        output = output.and((0, parse_all_of_js_1.parseAllOf)({
            ...objectSchema,
