...
export class ForgeState extends jspb.Message {
  ...
  clearReservedSymbolsList(): void;
  getReservedSymbolsList(): Array<string>;
  setReservedSymbolsList(value: Array<string>): void;
  addReservedSymbols(value: string, index?: number): string;
